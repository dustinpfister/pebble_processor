...
exports.getTransferMessgae = function (messCode) {
    ...
    switch (messCode) {
        ...
        case 4: return 'Same account transfer.'; break;
        case 3: return 'Not enough pebble.'; break;
        case 2: return 'Count not get account.'; break;
        case 1: return 'Generic message\/error code. Or no message code set.'; break;
        case 0: return 'Sucessful transfer.'; break;
                                ...
                                function () {
                                    ...
                                    /*
                                        self.pushTransfer({
                                            ...
                                            , amount: transReq.amount
                                            , status: 'fail'
                                            , messCode: 0 // 0 failed getting one or more accounts
