...
exports.pushTransfer = function (transReq, aurg, done) {
    ...
    if(aurg === undefined){ aurg = {};}
    if(aurg.messCode === undefined){ aurg.messCode = 0;}
    if(aurg.status === undefined){ aurg.status = 'fail';}
    ...
    processed.save(function () {
        ...
        TransferRequest.remove({transferNumber: transReq.transferNumber}, function(err){
