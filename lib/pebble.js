        ...
        if (processed) {
            ...
            fulfiller.fulfill(processed, function (processed) {
                ...
                TransferProcessed.remove({
                    ...
                    console.log('pebble.js: transaction purged.');
                ...
                console.log('pebble.js : failed to fulfil a processed transaction, transaction NOT purged');
...
exports.transferRequest = (function () {
    ...
    return function (options) {
        ...
        if(options.fulfillerData === undefined){ options.fulfillerData = {noData: true}; }
        ...
        accountRefCheck(options.from, function (fix) {
                ...
                accountRefCheck(options.to,
                    ...
                    function (fix) {
                        ...
                        //transfer.markModified('fulfillerData');
